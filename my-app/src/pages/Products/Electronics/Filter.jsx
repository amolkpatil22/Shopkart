    ...
    <Flex marginBottom={"20px"}>
      ...
      <Box>
        ...
        >
          ...
          <option value="Mobile" style={{ color: "white",background: "black" }}>Mobile</option>
          <option value="TV" style={{ color: "white",background: "black" }}>TV</option>
          <option value="Headphones" style={{ color: "white",background: "black" }}>Headphones</option>
